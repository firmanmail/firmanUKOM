            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('backend.admin.stock.index')}}">Stocks</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('backend.admin.suplier.index')}}">Supliers</a>
                        </li>
                        <li class="nav-item">
